...
static void _PI_TX_Tasks(void);
static void _PI_RX_Tasks(void);
...
void SYS_Tasks ( void )
{
    ...
    /* Create OS Thread for PI_TX Tasks. */
    xTaskCreate((TaskFunction_t) _PI_TX_Tasks,
                "PI_TX Tasks",
                1024, NULL, 1, NULL);

    /* Create OS Thread for PI_RX Tasks. */
    xTaskCreate((TaskFunction_t) _PI_RX_Tasks,
                "PI_RX Tasks",
                1024, NULL, 1, NULL);
...
/*******************************************************************************
  Function:
    void _PI_TX_Tasks ( void )

  Summary:
    Maintains state machine of PI_TX.
*/
...
/*******************************************************************************
  Function:
    void _PI_RX_Tasks ( void )

  Summary:
    Maintains state machine of PI_RX.
*/
